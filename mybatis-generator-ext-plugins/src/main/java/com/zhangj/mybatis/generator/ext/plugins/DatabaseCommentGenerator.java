...
public class DatabaseCommentGenerator extends DefaultCommentGenerator
{
    ...
    {
        if (!skipDatabaseComment && (introspectedColumn.getRemarks() != null && introspectedColumn.getRemarks().length() > 0))
        {
    ...
    public void addConfigurationProperties(Properties properties)
    {
        ...
        skipDatabaseComment = isTrue(properties.getProperty("skipDatabaseComment"));
        skipMethodComment = isFalse(properties.getProperty("skipMethodComment"));
